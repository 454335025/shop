...
<head>
    ...
    <link href="/css/shop/shop_car/common.css" rel="stylesheet" type="text/css">
    <link href="/css/shop/shop_car/guide_download.css" rel="stylesheet" type="text/css">
    <link href="/css/shop/common/ui.css" rel="stylesheet" type="text/css">
    <link href="/css/shop/shop_car/index.css" rel="stylesheet" type="text/css">
    <link href="/css/shop/shop_car/portrait.css" rel="stylesheet">
    <link href="/css/shop/shop_car/landscape.css" rel="stylesheet">
                        ...
                        <div class="cart-bar">
                            <div class="num-count fl">
                                ...
                                <a class="btn-add btn-add-select fl"
                                   href="/shop/shop_car/update_number?openid=<?php echo $user->openid ?>&id=<?php echo $shop_cart->id ?>&action=add"></a>
                            </div>
                            <div class="opt fr">
                                <a class="cart-del"
