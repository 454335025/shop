        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" id="image_form" method="post" action="add_shop_ware_image">
                        <input type="hidden" id="shop_ware_id" name="shop_ware_id" value="<?php echo $shop_ware_id;?>"/>
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
                                <button type="button" onclick="javascript:uploadImg();" class="btn btn-default">新增
                                </button>
                            </div>
                        </div>
                    </form>
